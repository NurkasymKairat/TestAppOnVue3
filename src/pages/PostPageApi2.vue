...
import { usePosts } from "@/hooks2/usePosts";
import useSortedPosts from "@/hooks2/useSortedPosts";
import useSortedAndSearchedPosts from "@/hooks2/useSortedAndSearchedPosts";
import { ref } from "vue";
export default {
  components: {
    PostForm,
